...
def build_parser() -> ArgumentParser:
    ...
    parser.add_argument("action", nargs="?", default="install", help="Action to run. Currently only: install.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if action != "install":
        raise SystemExit(f"Unknown action '{action}'. Currently supported: install")
